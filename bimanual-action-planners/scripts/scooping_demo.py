...
def query_scooping_attractors():
	...
	lA_p1_attr.translation.x = -0.0975
	lA_p1_attr.translation.y = -1.4084
	...
	lA_p2_attr.translation.x = -0.1209
	lA_p2_attr.translation.y = -1.4172
...
def query_depart_attractors():
	...
	lA_p3_attr.translation.x = -0.0959
	lA_p3_attr.translation.y = -1.4167
...
def query_trash_attractors():
	...
	lA_p4_attr.translation.x = -0.2770
	lA_p4_attr.translation.y = -1.8095
...
def query_retract_attractors():
	...
	# Phase 5 Left Arm Attractor in Task RF
	lA_p5_attr = geometry_msgs.msg.Transform()
	lA_p5_attr.translation.x = -0.3672
	lA_p5_attr.translation.y = -2.0300
