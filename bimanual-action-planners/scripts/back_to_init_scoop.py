...
if __name__ == '__main__':
	...
	rA_p2_attr.translation.x = -0.213
	rA_p2_attr.translation.y =  0.458
	rA_p2_attr.translation.z =  0.184

	rA_p2_attr.rotation.x    =  0.384
	rA_p2_attr.rotation.y    = -0.129
	rA_p2_attr.rotation.z    =  0.119
	rA_p2_attr.rotation.w    =  0.906
  
	lA_p2_attr = geometry_msgs.msg.Transform()
	lA_p2_attr.translation.x = -0.211
	lA_p2_attr.translation.y = -0.655
	lA_p2_attr.translation.z =  0.329

	lA_p2_attr.rotation.x    = -0.372
	lA_p2_attr.rotation.y    =  0.791
	lA_p2_attr.rotation.z    =  0.484
	lA_p2_attr.rotation.w    =  0.020
