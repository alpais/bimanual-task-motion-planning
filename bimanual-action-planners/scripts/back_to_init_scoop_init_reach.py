...
if __name__ == '__main__':
	...
	#  Right Arm Attractor in Task RF
	rA_p2_attr = geometry_msgs.msg.Transform()
	rA_p2_attr.translation.x = -0.122 
	rA_p2_attr.translation.y =  0.016
	rA_p2_attr.translation.z =  0.372

	rA_p2_attr.rotation.x    =  0.501
	rA_p2_attr.rotation.y    =  0.013
	rA_p2_attr.rotation.z    = -0.018
	rA_p2_attr.rotation.w    =  0.865

	lA_p2_attr = geometry_msgs.msg.Transform()
	lA_p2_attr.translation.x = -0.118 
	lA_p2_attr.translation.y = -0.637
	lA_p2_attr.translation.z =  0.403

	lA_p2_attr.rotation.x    = -0.337
	lA_p2_attr.rotation.y    =  0.734 
	lA_p2_attr.rotation.z    =  0.436
	lA_p2_attr.rotation.w    =  0.397
