...
def PLAN2CTRL_client(action_type, phase, task_frame, right_attractor_frame, right_role, left_attractor_frame, left_role, timeout):
    ...
    #-----------------------------------------------#    
    goal = bimanual_action_planners.msg.PLAN2CTRLGoal(action_type= action_type, action_name = phase, task_frame = task_frame, right_attractor_frame = right_attractor_frame, left_attractor_frame = left_attractor_frame, right_role = right_role, left_role = left_role, timeout = timeout)
...
if __name__ == '__main__':
	...
	result = PLAN2CTRL_client(action_type, 'Reach', task_frame, rA_p1_attr, lA_p1_attr, rA_p1_role, lA_p1_role, 10)
	print "Result:"		
	...
	result = PLAN2CTRL_client(action_type, 'Back',  task_frame, rA_p2_attr, lA_p2_attr, rA_p2_role, lA_p2_role,, 10)
	print "Result:"
	print result.success
